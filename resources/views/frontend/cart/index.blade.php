            ...
            <div class="cart-list-head">
                ...
                <div class="cart-single-list">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-1 col-md-2 col-12">
                            <a class="remove-item" onclick="return confirm('Are you sure to delte this product')" href="{{route('remove-cart-product',['id' => $cart_product->__raw_id])}}"><i class="lni lni-close"></i></a>
                        </div>
                    </div>
                </div>
